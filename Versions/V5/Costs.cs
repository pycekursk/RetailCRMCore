    ...
    public partial class Client
    {
        ...
        public Response CostsCreate(Dictionary<string, object> cost, string site = "")
        {
            ...
            return Request.MakeRequest(
                ...
                FillSite(
                    ...
                    {
                        { "cost", Newtonsoft.Json.JsonConvert.SerializeObject(cost) }
                    }
                )
            );
        }
        ...
        public Response CostsDelete(List<string> ids)
        {
            ...
            return Request.MakeRequest(
                ...
                new Dictionary<string, object>
                {
                    { "ids", Newtonsoft.Json.JsonConvert.SerializeObject(ids) }
                }
            );
        }
        ...
        public Response CostsUpload(List<object> costs)
        {
            ...
            return Request.MakeRequest(
                ...
                new Dictionary<string, object>
                {
                    { "costs", Newtonsoft.Json.JsonConvert.SerializeObject(costs) }
                }
            );
        }
